export const ProjectsData = [ 
    ...
    },
    {
        ...
        technologies:['Node.js', 'Express.js', 'MongoDB', 'React','TailwindCSS','Chart JS'],
        image: '/coincontrol-cover.png',
        github:'https://github.com/maricd7/coin-control',
    },
    {
        name:'Swift Sail CMS', 
        paragraphTxt:'Swift Sail CMS is a robust solution designed to efficiently manage the SwiftSail shop.',
