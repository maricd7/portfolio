...
export const Nav = () => {
  ...
  // },[])
  return (
    <nav className='flex justify-between  md:mx-auto  max-w-3xl items-center h-16   fixed top-0 left-0 w-full bg-white dark:bg-zinc-950 md:relative md:dark:bg-zinc-950'>
      <Logo />
